...
export function createCell(payload: Payload, options?: { skipCheckCapacityIsEnough?: boolean }): Cell {
...
export function createCellWithMinimalCapacity(payload: { lock: Script; type?: Script; data?: HexString }): Cell {
  const data = payload.data || "0x";
  let cellOutput = {
    capacity: "0x0",
    lock: payload.lock,
