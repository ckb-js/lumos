...
export interface Base {
   ...
   * @param tx_proof proof generated by {@link Base.getTransactionAndWitnessProof}
   * @returns the transaction hashes it commits to
   */
  verifyTransactionAndWitnessProof: (
    tx_proof: CKBComponents.TransactionAndWitnessProof
