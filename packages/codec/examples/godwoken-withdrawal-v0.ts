...
function main() {
  const buf = RawWithdrawalRequest.pack({
    ...
    amount: BI.from(1000),
    sudt_script_hash: "0x1234567812345678123456781234567812345678123456781234567812345678",
    account_script_hash: "0x1234567812345678123456781234567812345678123456781234567812345678",
    owner_lock_hash: "0x1234567812345678123456781234567812345678123456781234567812345678",
    payment_lock_hash: "0x1234567812345678123456781234567812345678123456781234567812345678",
