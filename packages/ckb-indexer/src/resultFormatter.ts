...
import { SearchFilter, SearchKey, GetTransactionRPCResult } from "./type";
...
const toTransactionRPCResult = (
  data: RPCType.GetTransactionRPCResult
): GetTransactionRPCResult => ({
  ...data,
  result: toTransactionWithStatus(data.result),
});
