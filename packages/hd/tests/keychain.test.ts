...
test("create master keychain from seed", (t) => {
  ...
  t.is(master.privateKey.toString("hex"), "e8f32e723decf4051aefac8e2c93c9c5b214313817cdb01a1494b917c8436b35");
  t.is(master.identifier.toString("hex"), "3442193e1bb70916e914552172cd4e2dbc9df811");
  t.is(master.fingerprint, 876747070);
  t.is(master.chainCode.toString("hex"), "873dff81c02f525623fd1fe5167eac3a55a049de3d314bb42ee227ffed37d508");
  t.is(master.index, 0);
  t.is(master.depth, 0);
...
test("derive children hardened", (t) => {
  ...
  t.is(child.privateKey.toString("hex"), "edb2e14f9ee77d26dd93b4ecede8d16ed408ce149b6cd80b0715a2d911a0afea");
  t.is(child.identifier.toString("hex"), "5c1bd648ed23aa5fd50ba52b2457c11e9e80a6a7");
  t.is(child.fingerprint, 1545328200);
  t.is(child.chainCode.toString("hex"), "47fdacbd0f1097043b78c63c20c34ef4ed9a111d980047ad16282c7ae6236141");
  t.is(child.index, 0);
  t.is(child.depth, 1);
});
...
test("derive path", (t) => {
  ...
  t.is(child.privateKey.toString("hex"), "cbce0d719ecf7431d88e6a89fa1483e02e35092af60c042b1df2ff59fa424dca");
  t.is(child.identifier.toString("hex"), "ee7ab90cde56a8c0e2bb086ac49748b8db9dce72");
  t.is(child.fingerprint, 4001020172);
  t.is(child.chainCode.toString("hex"), "04466b9cc8e161e966409ca52986c584f07e9dc81f735db683c3ff6ec7b1503f");
  t.is(child.index, 2);
  t.is(child.depth, 3);
});
...
test("create master keychain from long seed", (t) => {
  ...
  t.is(master.privateKey.toString("hex"), "4b03d6fc340455b363f51020ad3ecca4f0850280cf436c70c727923f6db46c3e");
  t.is(master.identifier.toString("hex"), "bd16bee53961a47d6ad888e29545434a89bdfe95");
  t.is(master.fingerprint, 3172384485);
  t.is(master.chainCode.toString("hex"), "60499f801b896d83179a4374aeb7822aaeaceaa0db1f85ee3e904c4defbd9689");
  t.is(master.index, 0);
  t.is(master.depth, 0);
  t.is(master.parentFingerprint, 0);
});
...
test("derive path large index", (t) => {
  ...
  t.is(child.privateKey.toString("hex"), "877c779ad9687164e9c2f4f0f4ff0340814392330693ce95a58fe18fd52e6e93");
  t.is(child.identifier.toString("hex"), "d8ab493736da02f11ed682f88339e720fb0379d1");
  t.is(child.fingerprint, 3635104055);
  t.is(child.chainCode.toString("hex"), "be17a268474a6bb9c61e1d720cf6215e2a88c5406c4aee7b38547f585c9a37d9");
  t.is(child.index, 2147483647);
  t.is(child.depth, 2);

  child = child.deriveChild(1, false);
  t.is(child.privateKey.toString("hex"), "704addf544a06e5ee4bea37098463c23613da32020d604506da8c0518e1da4b7");
  t.is(child.identifier.toString("hex"), "78412e3a2296a40de124307b6485bd19833e2e34");
  t.is(child.fingerprint, 2017537594);
  t.is(child.chainCode.toString("hex"), "f366f48f1ea9f2d1d3fe958c95ca84ea18e4c4ddb9366c336c927eb246fb38cb");
  t.is(child.index, 1);
  t.is(child.depth, 3);
  ...
  t.is(child.chainCode.toString("hex"), "637807030d55d01f9a0cb3a7839515d796bd07706386a6eddf06cc29a65a0e29");
...
test("derive children no hardened", (t) => {
  ...
  t.is(child.privateKey.toString("hex"), "abe74a98f6c7eabee0428f53798f0ab8aa1bd37873999041703c742f15ac7e1e");
  t.is(child.identifier.toString("hex"), "5a61ff8eb7aaca3010db97ebda76121610b78096");
  t.is(child.fingerprint, 1516371854);
  t.is(child.chainCode.toString("hex"), "f0909affaa7ee7abe5dd4e100598d4dc53cd709d5a5c2cac40e7412f232f7c9c");
  t.is(child.index, 0);
  t.is(child.depth, 1);
});
...
test("create child keychain from public key", (t) => {
  ...
  t.is(grandchild.publicKey.toString("hex"), "02e8445082a72f29b75ca48748a914df60622a609cacfce8ed0e35804560741d29");
  t.is(grandchild.chainCode.toString("hex"), "cfb71883f01676f587d023cc53a35bc7f88f724b1f8c2892ac1275ac822a3edd");
...
test("derive ckb keys", (t) => {
  ...
  t.is(extendedKey.privateKey.toString("hex"), "bb39d218506b30ca69b0f3112427877d983dd3cd2cabc742ab723e2964d98016");
  t.is(extendedKey.publicKey.toString("hex"), "03e5b310636a0f6e7dcdfffa98f28d7ed70df858bb47acf13db830bfde3510b3f3");
  t.is(extendedKey.chainCode.toString("hex"), "37e85a19f54f0a242a35599abac64a71aacc21e3a5860dd024377ffc7e6827d8");

  const addressKey = extendedKey.deriveChild(0, false).deriveChild(0, false);
  t.is(addressKey.privateKey.toString("hex"), "fcba4708f1f07ddc00fc77422d7a70c72b3456f5fef3b2f68368cdee4e6fb498");
  t.is(addressKey.publicKey.toString("hex"), "0331b3c0225388c5010e3507beb28ecf409c022ef6f358f02b139cbae082f5a2a3");
...
test("derive ckb keys another seed", (t) => {
  ...
  t.is(master.privateKey.toString("hex"), "37d25afe073a6ba17badc2df8e91fc0de59ed88bcad6b9a0c2210f325fafca61");
...
test("derive ckb keys from master extended key", (t) => {
  ...
  t.is(master.publicKey.toString("hex"), "020720a7a11a9ac4f0330e2b9537f594388ea4f1cd660301f40b5a70e0bc231065");
