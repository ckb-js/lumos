...
test("decrypts", (t) => {
  t.is(keystore.decrypt(password), new ExtendedPrivateKey(fixture.privateKey, fixture.chainCode).serialize());
});
...
test("load ckb cli standard keystore, loads private key", (t) => {
  ...
  const keystore = Keystore.fromJson(keystoreString);
  const extendedPrivateKey = keystore.extendedPrivateKey(password);
  t.is(extendedPrivateKey.privateKey, "0x8af124598932440269a81771ad662642e83a38b323b2f70223b8ae0b6c5e0779");
  t.is(extendedPrivateKey.chainCode, "0x615302e2c93151a55c29121dd02ad554e47908a6df6d7374f357092cec11675b");
});
