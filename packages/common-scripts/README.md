...
Check [Omnilock example](https://github.com/ckb-js/lumos/blob/develop/examples/omni-lock-metamask/lib.ts) and [pw lock example](https://github.com/ckb-js/lumos/blob/develop/examples/pw-lock-metamask/lib.ts) for how to use `p2pkh` script.
