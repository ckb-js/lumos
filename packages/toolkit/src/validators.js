...
function assertObjectWithKeys(debugPath, object, expectedKeys, optionalKeys = []) {
  ...
  const errorMessage = `${debugPath} does not have correct keys! Required keys: [${expectedKeys
    .sort()
    .join(", ")}], optional keys: [${optionalKeys.sort().join(", ")}], actual keys: [${providedKeys.join(", ")}]`;
...
export function ValidateOutPoint(outPoint, { nestedValidation = true, debugPath = "outPoint" } = {}) {
...
export function ValidateCellInput(cellInput, { nestedValidation = true, debugPath = "cellInput" } = {}) {
...
export function ValidateCellOutput(cellOutput, { nestedValidation = true, debugPath = "cellOutput" } = {}) {
...
export function ValidateCellDep(cellDep, { nestedValidation = true, debugPath = "cellDep" } = {}) {
...
export function ValidateRawTransaction(rawTransaction, { nestedValidation = true, debugPath = "rawTransaction" } = {}) {
...
export function ValidateRawHeader(rawHeader, { nestedValidation = true, debugPath = "rawHeader" } = {}) {
  assertObjectWithKeys(
    debugPath,
    rawHeader,
    [
...
export function ValidateUncleBlock(uncleBlock, { nestedValidation = true, debugPath = "uncleBlock" } = {}) {
...
export function ValidateWitnessArgs(witnessArgs, { nestedValidation = true, debugPath = "witnessArgs" } = {}) {
