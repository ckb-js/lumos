...
let _codec = require("@ckb-lumos/codec");

const { Uint128LE, Uint8, Uint32LE, Uint64LE } = _codec.number;
const { byteVecOf, option, table, vector, struct } = _codec.molecule;
const { bytify, hexify } = _codec.bytes;
